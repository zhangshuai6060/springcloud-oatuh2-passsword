...
-- ----------------------------
INSERT INTO `oauth_client_details` VALUES ('client', NULL, '$2a$10$rfjh0xBSbAih956yoisDFOFKVNjJzByET0ShRNzVs9M9oqQQlvjki', 'app', 'authorization_code,password,refresh_token,client_credentials', 'http://www.baidu.com,http://localhost:9090/GetToken', NULL, NULL, NULL, NULL, 'true');
...
CREATE TABLE `sys_role`  (
  ...
  `type` tinyint(4) NULL DEFAULT NULL COMMENT '1.后台2.前台',
  `create_by` bigint(20) NULL DEFAULT NULL COMMENT '创建人id',
  `create_time` datetime(0) NULL DEFAULT current_timestamp(0) COMMENT '创建时间',
  `last_modify_by` bigint(20) NULL DEFAULT NULL COMMENT '上次修改人id',
  `last_modify_time` datetime(0) NULL DEFAULT current_timestamp(0) COMMENT '上次修改时间',
  `logical_deleted` tinyint(4) NULL DEFAULT 1 COMMENT '逻辑删除1.正常2.已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_role_menu` VALUES (27, 2, 6, 2, '2020-06-10 17:36:15', 2, '2020-06-10 17:36:15', 1);
